                    ...
                    <table>
                        ...
                        if ($res->num_rows > 0){
                            while($linha = $res->fetch_assoc()){
                                ...
                                "<td>".$linha['genero']."</td>".
                                "<div class="."botoes".">".
                                "<td><a href="."alterarLivro.php?cod=$cod".">"."<img border="."0"." alt="."alterar"." src="."../View/icons/editar.svg"." width="."30"." height="."30"."></a>".
                                ...
                                "<td><a href=".""."><img border="."0"." alt="."alterar"." src="."../View/icons/deletar.svg"." width="."30"." height="."30"."></a>".
                                "</div>";
                                echo "</tr>";
                            }
                        }
